...
import { EditQuotationPageProps, QuotationResponse } from '../api/type';
import EditQuotationProvider from './EditQuotationProvider.client';

const EditQuotationServer: FC<EditQuotationPageProps> = async ({
  params,
  searchParams,
}) => {
...
export default EditQuotationServer;
